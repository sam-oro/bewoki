        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav hola ml-auto">
                ...
                <div class="btn-group">
                    ...
                    <a class="nav-link" href="<?php echo  $URL ?>vistas/usuario/iniciar_sesion.php"><button class="dropdown-item" type="button">Ingresar</button></a>
                    <a class="nav-link" href="<?php echo  $URL ?>vistas/usuario/form_usuario.php"><button class="dropdown-item" type="button">Registrarse</button></a>
                    </div>
                </div>
            </ul>
        </div>
